...
public:
                    ...
                    const ReferenceManagerInterface& referenceManager) override
  {
    ...
    for (size_t i = 0; i < 2; ++i)
      params_(i + 4) = (params_.segment<2>(0) - points.segment<2>(i * 2)).norm() - params_(2) - 0.35 / 2.;
  }
...
public:
  ...
  {
    return distance_.getParameters();
  }
  DCbfSimpleAd* clone() const override
  {
    return new DCbfSimpleAd(*this);
  }
