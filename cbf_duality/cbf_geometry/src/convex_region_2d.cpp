...
Rectangle2d<SCALAR>::Rectangle2d(const vector_temp<SCALAR>& pose, const vector_temp<SCALAR>& size)
  : ConvexRegion2d<SCALAR>(4)
{
...
{
  size_t size_points = points.size() / 2;  // The num_points actually greater or equal the size of points/2
